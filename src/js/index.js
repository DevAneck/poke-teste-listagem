/*
    ...
    - objetivo 1 - quando cliecar no botão de troca de tema, adicionar a classe modo-escuro no body pra que os estilos do modo escuro sejam aplicados e mudar imagem pra lua
    ...
    - objetivo 2 - quando clicar no botao de troca de tema, caso o body ja tenha a classe modo-escuro, remover a classe pra mudar pro modo claro e mudar a imagem pro sol
        - passo 6 - remover a clase do modo-escuo do body
...
botaoAlterarTema.addEventListener("click", ()=> { 
 ...
 if(modoEscuroEstaAtivo){
    ...
    // passo 8 - troca a imagem do botao de alterar tema para sol
